...
class FirstWarning extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'first_warning';
    ...
    public function handle()
    {
        ...
        try {
            $listings = MaliOglasi::whereBetween('datum_poteka', [ date('Y-m-d H:i:s', strtotime($warningDate)), date('Y-m-d H:i:s', strtotime($warningDate->addHour(120)))])
                ->where('warning_sent', null)
                ->get();
